...
// ✅ Identify Chat Partner for Account Officer
if ($current_role_id == 6) { // Account Officer → Branch Manager
    $stmt = $pdo->prepare("SELECT id FROM users WHERE role_id = 5 LIMIT 1");
} else {
    die("<p style='text-align:center;color:red;'>Access Denied! Only Account Officer can access this chat.</p>");
}
$stmt->execute();
...
<head>
<meta charset="UTF-8">
<title>Chat | Account Officer & Branch Manager</title>
...
<div class="chat-container">
    <h3 style="text-align:center;color:#333;margin-bottom:15px;">
        Chat between Account Officer and Branch Manager
    </h3>
